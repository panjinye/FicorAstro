...
function r() {
  return r = Object.assign ? Object.assign.bind() : function(e2) {
    for (var t = 1; t < arguments.length; t++) {
      var s = arguments[t];
      for (var r2 in s) ({}).hasOwnProperty.call(s, r2) && (e2[r2] = s[r2]);
    }
    return e2;
...
var l2 = class extends e {
  ...
  async preload(e2, s = {}) {
    ...
    if (!o2) return;
    if (this.swup.cache.has(o2)) return this.swup.cache.get(o2);
  ...
  preloadVisibleLinks() {
    ...
    this.preloadObserver = (function({ threshold: e3, delay: s2, containers: r3, callback: o2, filter: i2 }) {
      const a2 = /* @__PURE__ */ new Map(), l3 = new IntersectionObserver((e4) => {
        e4.forEach((e5) => {
          e5.isIntersecting ? h(e5.target) : u(e5.target);
        });
      }, { threshold: e3 }), h = (e4) => {
        var r4;
      ...
      return { start: () => d(), stop: () => l3.disconnect(), update: () => (a2.clear(), d()) };
