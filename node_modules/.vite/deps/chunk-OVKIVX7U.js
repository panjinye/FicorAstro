...
async function $({ selector: t, elements: e }) {
  ...
  const s2 = i2.map((t2) => (function(t3) {
    const { type: e2, timeout: i3, propCount: s3 } = (function(t4) {
      const e3 = window.getComputedStyle(t4), i4 = A(e3, `${U}Delay`), s4 = A(e3, `${U}Duration`), n2 = x(i4, s4), o2 = A(e3, `${P}Delay`), r2 = A(e3, `${P}Duration`), a2 = x(o2, r2), l2 = Math.max(n2, a2), h = l2 > 0 ? n2 > a2 ? U : P : null;
...
//# sourceMappingURL=chunk-OVKIVX7U.js.map
